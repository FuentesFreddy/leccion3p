...
class PostManager {
    ...
    private uiOutput: HTMLElement | null = null;
    ...
    private log(actionMessage: string, data?: any): void {
    ...
    private renderUi(posts: Post | Post[]): void {
    ...
    async getPostsByUserId(userId: number): Promise<void> {
    ...
    async createPost(title: string, body: string, userId: number): Promise<void> {
    ...
    async updatePostTitle(id: number, newTitle: string): Promise<void> {
...
if (typeof document !== 'undefined') {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('form-get-id')?.addEventListener('submit', (e) => {
            e.preventDefault();
            const val = (document.getElementById('input-id') as HTMLInputElement).value;
            manager.getPostById(parseInt(val));
        });

        document.getElementById('form-filter-user')?.addEventListener('submit', (e) => {
            e.preventDefault();
            const val = (document.getElementById('input-user-id') as HTMLInputElement).value;
            manager.getPostsByUserId(parseInt(val));
        });

        document.getElementById('form-create')?.addEventListener('submit', (e) => {
            e.preventDefault();
            const uId = parseInt((document.getElementById('create-user') as HTMLInputElement).value);
            const t = (document.getElementById('create-title') as HTMLInputElement).value;
            const b = (document.getElementById('create-body') as HTMLTextAreaElement).value;
        ...
        document.getElementById('form-patch')?.addEventListener('submit', (e) => {
            e.preventDefault();
            const id = parseInt((document.getElementById('patch-id') as HTMLInputElement).value);
            const t = (document.getElementById('patch-title') as HTMLInputElement).value;
        ...
        document.getElementById('form-delete')?.addEventListener('submit', (e) => {
            e.preventDefault();
            const val = (document.getElementById('delete-id') as HTMLInputElement).value;
